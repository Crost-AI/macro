...
for name in summary.json wasm-inspection.json web-glue-inspection.json \
  worker-source-inspection.json wasm.sha256 toolchain.json; do
...
echo "regenerated hashes, toolchain, inspections, and deterministic summary match committed files"
